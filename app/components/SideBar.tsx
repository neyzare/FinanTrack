...
import { LayoutDashboard, TrendingUp, Calculator, Wallet, Settings, ChartCandlestick, ChartLine, Menu, X } from 'lucide-react';
...
const menuItems = [
    ...
    { id: 'analyse', label: 'Analyse', icon: ChartLine, href: '/dashboard/analyse' },
