  ...
  return (
    <footer className="footer sm:footer-horizontal bg-card text-card-foreground border-t border-border p-10">
      ...
      <nav>
        ...
        <Link href="/dashboard/portefeuille" className="link link-hover">
          Portefeuille
        </Link>
        <Link href="/dashboard/sandbox" className="link link-hover">
          Simulation
        </Link>
        <Link href="/dashboard/calculatrice" className="link link-hover">
          Calculatrice
        </Link>
      </nav>
      ...
      <nav>
        ...
        <Link href="/dashboard/parametres" className="link link-hover">
          Paramètres
        </Link>
      </nav>
