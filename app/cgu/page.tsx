        ...
        <CardContent className="space-y-6 text-sm leading-relaxed">
          <section className="space-y-2">
            ...
            <p>
              ...
              CGU ») régissent l&apos;utilisation du site Finantrack, plateforme
              pédagogique de suivi et de simulation d&apos;investissement
              boursier. L&apos;utilisation du service implique
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              ...
              <li>
                Ne pas extraire massivement les données accessibles via le site
              </li>
              <li>
                Respecter les droits de propriété intellectuelle de
                l&apos;éditeur et des tiers
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              service mais ne peut garantir un fonctionnement ininterrompu. Des
              opérations de maintenance peuvent rendre le service temporairement
              indisponible sans préavis.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              les paramètres. L&apos;éditeur se réserve le droit de suspendre ou
