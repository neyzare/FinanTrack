      ...
      <Card className="w-full max-w-3xl border-2 shadow-xl">
        ...
        <CardContent className="space-y-6 text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              <li>
                Positions et historique de votre portefeuille de simulation
              </li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              ...
              <li>
                Vous permettre d&apos;utiliser les fonctionnalités du site
              </li>
              <li>
                Vous envoyer un email de réinitialisation de mot de passe à
                votre demande
              </li>
            </ul>
            <p>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              <li>
                <strong>IONOS</strong> (hébergement)
              </li>
              <li>
                <strong>Resend</strong> (envoi d&apos;emails transactionnels)
              </li>
              <li>
                <strong>Finnhub.io</strong> (données de marché - aucune donnée
