          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={donneesDepenses}>
                ...
                <YAxis
                  stroke="currentColor"
                  tickFormatter={(valeur: number) => `${valeur}€`}
                />
                <Tooltip
                  contentStyle={{
            ...
            <p className="text-sm">
              {tauxEpargne >= 20 ? (
                <span className="text-success">
                  ✓ Excellent ! Vous épargnez {tauxEpargne.toFixed(1)}% de vos
                  revenus.
                </span>
              ) : tauxEpargne >= 10 ? (
                <span className="text-[#F59E0B]">
                  ⚠ Correct. Essayez d&apos;épargner au moins 20% de vos
                  revenus.
                </span>
              ) : (
                <span className="text-destructive">
                  ⚠ Attention ! Votre taux d&#39;épargne est faible. Réduisez
                  vos dépenses si possible.
                </span>
              )}
            </p>
          </div>
