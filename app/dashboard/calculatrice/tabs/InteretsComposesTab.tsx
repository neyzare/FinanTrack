...
export function InteretsComposesTab() {
    ...
    const donnees = calculerInteretsComposes({ capital, apportMensuel, tauxAnnuel, annees });
            ...
            <Card className="border-2 lg:col-span-1">
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input id="capital" type="number" value={capital} onChange={(e) => setCapital(Number(e.target.value))} />
                        <p className="text-xs text-muted-foreground">{capital.toLocaleString('fr-FR')} €</p>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="apport">Apport mensuel</Label>
                        <Input id="apport" type="number" value={apportMensuel} onChange={(e) => setApportMensuel(Number(e.target.value))} />
                        <p className="text-xs text-muted-foreground">{apportMensuel.toLocaleString('fr-FR')} €</p>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="taux">Taux annuel (%)</Label>
                        <Input id="taux" type="number" value={tauxAnnuel} onChange={(e) => setTauxAnnuel(Number(e.target.value))} step="0.1" />
                    </div>
                    <div className="space-y-2">
