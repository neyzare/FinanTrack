  ...
  const indicators = [
    {
      name: "RSI (14)",
      icon: Gauge,
      valeur: rsi.toFixed(1),
      description: "surachat > 70, survente < 30",
    },
    { name: "MACD", icon: Activity, valeur: macd.toFixed(2) },
    {
      name: "SMA 50",
      icon: TrendingUp,
      valeur: `${sma50.toFixed(2)} $`,
      description: `SMA 200 : ${sma200.toFixed(2)} $`,
    },
    {
      name: "Volatilité",
      icon: Waves,
      valeur: `${volatility.toFixed(1)} %`,
      description: "annualisée",
    },
  ];
