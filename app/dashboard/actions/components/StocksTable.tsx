        ...
        <table className="w-full text-left border-collapse min-w-[680px]">
          <thead>
            <tr className="border-b border-border sticky top-0 bg-card">
              ...
              <th className="py-3 px-4 text-muted-foreground font-semibold text-right">
                Actions
              </th>
            </tr>
          </thead>
            ...
            {stocks.map((stock) => {
              ...
              return (
                ...
                >
                  ...
                  <td
                    className={`py-3 px-4 tabular-nums ${isUp ? "text-green-500" : "text-red-500"}`}
                  >
                  ...
                  <td className="py-3 px-4">
                    <input
                      ...
                      onChange={(e) =>
                        onUpdateQuantity(stock.id, Number(e.target.value))
                      }
            ...
            <div key={stock.id} className="rounded-lg border border-border p-4">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`tabular-nums ${isUp ? "text-green-500" : "text-red-500"}`}
                  >
                    {stock.variation != null
                      ? `${stock.variation.toFixed(2)}%`
                      : "-"}
