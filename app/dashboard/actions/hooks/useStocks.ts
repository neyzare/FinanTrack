...
import { addStock, deleteStock as deleteStockFromDB, updateStock } from "@/app/lib/stocks-db";
...
export function useStocks(initialStocks: StockWithQuote[]) {
    ...
    return { stocks, errors, setErrors, updateQuantity, deleteStockHandler, ajouterStock };
}
